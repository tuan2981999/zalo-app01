...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Sao chép sản phẩm</h4>
                ...
                <div class="row" style="margin-bottom: 10px">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="txtIdphoto" id="txtIdphoto" value="{{$detail_product['photo_links'][0]}}" hidden/>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="industry3" name="industry3">
                        ...
                        <div> 
                            <button type="submit" class="btn btn-primary mr-2" name="btnUpdate">Sao chép sản phẩm</button>
